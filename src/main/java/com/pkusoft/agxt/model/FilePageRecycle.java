...
/**
 * @author
 * @title: FilePageRecycle
 */
@ApiModel("案卷页回收记录表")
@Table(name = "FILE_PAGE_RECYCLE")
public class FilePageRecycle {
    ...
    private String treePath;
 	...
 	/**
     * 数据操作类型(0010-作废并且物理删除)
     */
    @Column(name = "OPER_TYPE")
    @ApiModelProperty(value = "数据操作类型(0010-作废并且物理删除)")
