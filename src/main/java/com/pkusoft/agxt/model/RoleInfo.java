...
public class RoleInfo {
    ...
    private Double sn;
 	...
 	/**
     * 数据权限 负数 - 级别向上(权限大) 0       - 正常 正数 - 级别向下(权限小)
     */
    @Column(name = "DATA_LEV")
    @ApiModelProperty(value = "数据权限 负数 - 级别向上(权限大) 0       - 正常 正数 - 级别向下(权限小)")
    ...
    */
    ...
    /**
    * 获得数据权限 负数 - 级别向上(权限大) 0       - 正常 正数 - 级别向下(权限小)
    * @return DATA_LEV
    */
    ...
    /**
    * 设置数据权限 负数 - 级别向上(权限大) 0       - 正常 正数 - 级别向下(权限小)
    * @param dataLev
    */
