 ...
 */
@ApiModel("案卷柜操作轨迹表")
@Table(name = "CAB_TRACK")
public class CabTrack {
    ...
    private String reserve3;
 	...
 	/**
     * 备注("1"代表case开柜,"2"代表web端开柜,3:人像案管柜)
     */
    @Column(name = "MEMO")
    @ApiModelProperty(value = "备注('1'代表case开柜,'2'代表web端开柜,3:人像案管柜)")
    private String memo;
    ...
    */
    ...
    /**
    * 获得备注("1"代表case开柜,"2"代表web端开柜,3:人像案管柜)
    * @return MEMO
    */
    ...
    /**
    * 设置备注("1"代表case开柜,"2"代表web端开柜,3:人像案管柜)
    * @param memo
    */
