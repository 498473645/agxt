...
public class SysPermit {
    ...
    @ApiModelProperty(value = "数据权限标识号", required = false, example = "数据权限标识号")
    ...
    @ApiModelProperty(value = "数据权限名称", required = false, example = "数据权限名称")
    ...
    @ApiModelProperty(value = "数据权限值", required = false, example = "数据权限值")
    ...
    @ApiModelProperty(value = "数据权限类别编码", required = false, example = "数据权限类别编码")
    ...
    @ApiModelProperty(value = "数据权限类别名称", required = false, example = "数据权限类别名称")
    ...
    @ApiModelProperty(value = "排序", required = false, example = "排序")
     ...
     */
    @Column(name = "SYS_ID")
    @ApiModelProperty(value = "所属系统ID", required = false, example = "所属系统ID")
    ...
    @ApiModelProperty(value = "所属系统名称", required = false, example = "所属系统名称")
    ...
    @ApiModelProperty(value = "用户单位ID", required = false, example = "用户单位ID")
    ...
    @ApiModelProperty(value = "用户单位名称", required = false, example = "用户单位名称")
    ...
    @ApiModelProperty(value = "备用字段", required = false, example = "备用字段")
    ...
    @ApiModelProperty(value = "是否选中=>后台使用，不需要存数据", required = false, example = "是否选中=>后台使用，不需要存数据")
