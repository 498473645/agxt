...
import pkubatis.model.BaseModel;
...
public class SysUser extends BaseModel implements Serializable {
    ...
    private String certificate;     //数字证书编码

    @Column(name = "CUNITID")
    private String cunitid;     //数据归属市局

    @Column(name = "SUNITID")
    private String sunitid;     //数据归属分局

    @Column(name = "TUNITID")
    private String tunitid;     //数据归属派出所

    @Column(name = "RESERVE1")
    private String reserve1;     //保留字段1(当前用户所属单位的上级管辖单位代码)

    @Column(name = "RESERVE2")
    private String reserve2;     //保留字段2

    @Column(name = "RESERVE3")
    private String reserve3;     //10 市局大屏，11 问题列表，12 个人问题列表；20 分局大屏，21 问题列表，22 个人问题列表；30 所有问题列表，31 个人问题列表

    @Column(name = "RESERVE4")
    private String reserve4;     //微信号

    @Column(name = "RESERVE5")
    private String reserve5;     //钉钉号(userId)
    ...
    private String boundLogin;     //用户登录是否绑定ip地址（默认不绑定登录，绑定登录时需要输入绑定的ip地址）

    @Column(name = "IP")
    private String ip;     //用户绑定ip地址，（可绑定多个ip，用逗号分隔）

    @Column(name = "MAC_ADDRESS")
    private String macAddress;     //用户绑定MAC地址

    @Column(name = "ISUPDATE")
    private String isupdate;     //密码修改权限(1、允许修改密码，0、不允许修改密码)

    @Column(name = "HAS_FINGER")
    private Integer hasFinger;     //是否采集指纹（1：是，0：否）


    @Column(name = "HAS_LRIS")
    private Integer hasLris;     //是否采集虹膜（1：是，0：否）

    @Column(name = "USER_LXBM")
    private Integer userLxbm;     //用户类型编码
