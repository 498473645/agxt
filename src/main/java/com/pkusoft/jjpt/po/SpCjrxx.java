...
public class SpCjrxx {
    ...
    @Column(name = "PJ_DATA")
    private java.util.Date pjData;     //派警时间

    @Column(name = "DC_DATA")
    private java.util.Date dcData;     //到场时间

    @Column(name = "FK_DATA")
    private java.util.Date fkData;     //反馈时间

    @Column(name = "BC_DATA")
    private java.util.Date bcData;     //补充时间
    ...
    * @return PJ_DATA
    */
    public java.util.Date getPjData() {
        return this.pjData;
    }
    ...
    * @param pjData
    */
    public void setPjData(java.util.Date pjData) {
        this.pjData = pjData;
    }
    ...
    * @return DC_DATA
    */
    public java.util.Date getDcData() {
        return this.dcData;
    }
    ...
    * @param dcData
    */
    public void setDcData(java.util.Date dcData) {
        this.dcData = dcData;
    }
    ...
    * @return BC_DATA
    */
    public java.util.Date getBcData() {
        return this.bcData;
    }
    ...
    * @param bcData
    */
    public void setBcData(java.util.Date bcData) {
        this.bcData = bcData;
    }
