...
@Table(name = "SP_JJXX")
public class SpJjxxReqParam extends Page {
    ...
    private String startBjsj;     //报警时间-开始

    private String endBjsj;     //报警时间-截止

    private String startCjsj;     //报警时间-开始

    private String endCjsj;     //报警时间-截止
    ...
    */
    ...
    public String getStartCjsj() {
        return startCjsj;
    }

    public void setStartCjsj(String startCjsj) {
        this.startCjsj = startCjsj;
    }

    public String getEndCjsj() {
        return endCjsj;
    }

    public void setEndCjsj(String endCjsj) {
        this.endCjsj = endCjsj;
    }
    ...
    */
    ...
    public String getStartBjsj() {
        return startBjsj;
    }

    public void setStartBjsj(String startBjsj) {
        this.startBjsj = startBjsj;
    }
