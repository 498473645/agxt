...
public class SpCallRecordReqParam extends Page {

    private String startBjsj;     //报警时间-开始

    private String endBjsj;     //报警时间-截止

    private String startClsj;     //处理时间-开始

    private String endClsj;     //处理时间-截止
    ...
    */
    ...
    public void setStartClsj(String startClsj) {
        this.startClsj = startClsj;
    }
    ...
    public void setEndClsj(String endClsj) {
        this.endClsj = endClsj;
    }
}
