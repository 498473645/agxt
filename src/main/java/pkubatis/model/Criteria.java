...
public final class Criteria {
	...
	public BaseCriteria or(Class<BaseCriteria> criteriaClazz) {
		try {
			BaseCriteria criteria = criteriaClazz.newInstance();
			oredCriteria.add(criteria);
			return criteria;
		} catch (Exception e) {
	...
	public BaseCriteria createCriteria(Class<BaseCriteria> criteriaClazz) {
		try {
			BaseCriteria criteria = criteriaClazz.newInstance();
